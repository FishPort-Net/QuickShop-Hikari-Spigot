...
| Post-6.2.0.10 Minecraft adapters | Packet/display adapters and fixes for Minecraft versions introduced after the 6.2.0.10 range, including 1.21.10/1.21.11-specific work, are omitted. | The supported Minecraft range stays aligned with 6.2.0.10; no unverified newer-version claim is made. |
